...
<head>
    ...
    <title>Header</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Hi, I'm Copilot.
        ...
        <div class="container-fluid bg-dark navbar-dark mb-3 p-3">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active hdr" aria-current="page" href="#webHome">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active hdr" href="#about">About-Us</a>
              </li>

              <li class="nav-item">
                <a class="nav-link active hdr" href="#catogeries">Catogeries</a>
              </li>
              
              <li class="nav-item">
                <a class="nav-link active hdr" href="#chefs">Rental Experts</a>
              </li>
              
               <li class="nav-item">
                <a class="nav-link active hdr" href="#contact">Contact Us</a>
              </li>
