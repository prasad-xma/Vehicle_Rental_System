...
public class testDB1 {
	...
	public static void main(String[] args) {
		 ...
		 ArrayList<owner> owners = t1.getAllowner();
	...
	public void regvehicle(owner own) {
		try {
			...
			String query = "insert into vehicle (description, registrationNo, amt, added_date, catid, ftype, passengers, rentalPrice, image, rating, status, voId, tradeName, brand) "
	...
	public void updateVehicle(owner owner) {
		...
		try {
			...
			String query = "update vehicle SET description='"+owner.getDescription()+"',registrationNO='"+owner.getRegistrationNo()+"',AMT='"+owner.getAmt()+"',added_date='"+owner.getAdded_date()+"',catID='"+owner.getCatid()+"',ftype='"+owner.getFtype()+"',passengers='"+owner.getPassengers()+"',rentalPrice='"+owner.getRentalprice()+"',image='"+owner.getImage()+"',rating='"+owner.getRating()+"',status='"+Status+"',voID='"+owner.getVoId()+"',tradeName='"+owner.getTradeName()+"',brand='"+owner.getBrand()+"' where vid='"+owner.getVid()+"'";
